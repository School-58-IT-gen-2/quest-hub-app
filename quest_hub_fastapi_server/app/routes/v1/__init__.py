...
from quest_hub_fastapi_server.app.routes.v1.experience import exp_route
from quest_hub_fastapi_server.app.routes.v1.gold import gold_route
...
route.include_router(exp_route)
route.include_router(gold_route)
