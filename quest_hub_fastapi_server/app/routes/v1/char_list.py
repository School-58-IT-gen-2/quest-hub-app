...
@char_route.get(path="/char-list/{character_id}/inventory")
...
@char_route.get(path="/char-list/{character_id}/ammunition")
...
@char_route.get(path="/char-list/{character_id}/notes")
